    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        ...
        <Image
          ...
          width={112}
          height={112}
          className="pointer-events-none absolute -right-10 top-6 w-28 opacity-[0.12]"
        />
        <Image
          aria-hidden="true"
          src="/brand/mas.png"
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-vaul-no-drag
      className={cn(
        "mt-auto flex flex-col gap-2 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] touch-manipulation",
        className
      )}
      {...props}
    />
